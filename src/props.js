...
export const TABLE = {
  canvas: { x: 0.5, z: -3.35 },
  palette: { x: -0.43, z: -2.72, turn: 0.12 },
  ...
  tubes: [
    [-0.516, -3.406, -0.405], [0.755, -2.633, 0.948], [-0.424, -3.339, -0.422], [1.0, -2.677, 0.874], [-0.516, -3.124, 1.099],
    [0.4, -2.638, 0.743], [0.046, -2.692, 0.962], [-0.314, -3.293, -0.437], [0.513, -2.68, 0.712],
  ],
...
export function addPaintProps(room) {
  ...
  [['flat', 0xc7402d, 0.45, 0.32], ['filbert', 0x3b7d6b, 0.28, 0.08], ['round', 0xe0b23a, 0.58, 0.46]].forEach(([shape, colour, tiltZ, tiltX], i) => {
    const b = makeBrush(shape, colour);
    b.position.set(-0.03 + i * 0.03, 0.03, -0.01 + (i - 1) * 0.012);
    b.rotation.set(tiltX, 0, tiltZ);                                      // lean them against the rim, towards the canvas
