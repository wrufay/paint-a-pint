...
**0:30 - your own colours (20 s).** Point at the tray under the canvas: *"this is my real palette, a styrofoam tray."* Click the lemon yellow tube, then tap the tray to squeeze a blob out where you want it. Click king's blue and drag a line beside it. Switch the card to **mix & pick**, drag through both: green appears. Tap the green: your brush chip changes, and you paint with it. Say: *"You don't pick from a fixed set. You mix your own colours, the way you actually learn colour."*
