...
**0:30 - your own colours (20 s).** Point at the wooden palette on the right, in the sun: *"my palette. I squeeze paint out where I want it and mix on it."* Click the lemon yellow tube, then tap the palette to squeeze a blob out where you want it. Click king's blue and drag a line beside it. Switch the card to **mix & pick**, drag a knife through both: green appears. Tap the green: your brush chip changes, and you paint with it. Say: *"You don't pick from a fixed set. You mix your own colours, the way you actually learn colour."*

**0:50 - it's wet, then it isn't (15 s).** Press **w**: blue tint = still workable, orange = getting tacky, none = dry. Say: *"Every stroke has open time. Watch."* Press **w** to turn it off, then hit **dry now**. Say: *"Now it's dry."* Press **7** (burnt sienna) and paint a stroke across the dry green: it **covers** it and does not blend. That is wet-on-dry.

**1:05 - texture (10 s).** Pick the **round** brush and tap a few dabs for texture. Switch to **filbert** and press lightly, then firmly: the width follows pressure. Point at the ridges the bristles leave in thick paint. Pick the **knife** and lay a flat slab of paint, like the impasto skies in the reference painting.

**1:15 - the room (15 s).** Hover a tube for its colour, opacity and what it is for. Click **stand it up**: the canvas goes back on the easel for a bigger close-up. Say: *"And the paint is lit by the room, so thickness reads as thickness."* Click **stand it up** if you want the easel view again.

**1:30 - the ending (10 s).** Click **hang it up & go back**. The painting appears in a frame on the wall. Say: *"Zero cost, zero cleanup. It's for people who want to paint and don't want the friction."* Optionally mention what's next: masking tape, a Wacom, choosing where paintings hang.
...
- **Painting the wrong colour:** **z** undoes a stroke, and keeps going back (up to 40 steps). Clear and dry now can be undone too.
- **The tray dries too:** paint on it stays workable for minutes. Press **wipe** in the tray tools to scrape it clean (and **z** or undo does not cover the tray).
